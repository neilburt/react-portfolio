    ...
    <div className="about container-fluid d-flex flex-column justify-content-center">
      <div className="about-text">
        ...
        <div className="bio">
          ...
          <p>
          I have recently completed the rigorous web development certificate program through the University of Minnesota and am excited to continue learning and eager to maintain this momentum into the field, contributing work ethic, loyalty, and extensive experience in collaboration and customer satisfaction to the success of a business.
          </p>
          <p>
